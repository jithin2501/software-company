      ...
      <div className="max-w-[1240px] mx-auto px-6 md:px-12 pb-24 md:pb-32 relative z-10">
        ...
        <div className="hidden lg:block relative w-[1144px] h-[520px] mx-auto -mt-16">
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none overflow-visible" viewBox="0 0 1144 520" fill="none">
            ...
            <path d="M 390 108 Q 449 108, 508 184" stroke="#8b5cf6" strokeWidth="2" strokeDasharray="4 4" strokeLinecap="round" />
            <circle cx="508" cy="184" r="4" fill="#8b5cf6" />

            {/* 02: Integrity (blue curve) */}
            <path d="M 754 108 Q 695 108, 636 184" stroke="#3b82f6" strokeWidth="2" strokeDasharray="4 4" strokeLinecap="round" />
            <circle cx="636" cy="184" r="4" fill="#3b82f6" />
            ...
            <path d="M 390 412 Q 449 412, 508 336" stroke="#a855f7" strokeWidth="2" strokeDasharray="4 4" strokeLinecap="round" />
            <circle cx="508" cy="336" r="4" fill="#a855f7" />

            {/* 04: Excellence (orange curve) */}
            <path d="M 754 412 Q 695 412, 636 336" stroke="#f97316" strokeWidth="2" strokeDasharray="4 4" strokeLinecap="round" />
            <circle cx="636" cy="336" r="4" fill="#f97316" />
          </svg>
